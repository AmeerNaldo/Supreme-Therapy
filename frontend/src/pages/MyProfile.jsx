...
const MyProfile = () => {
  const [userData, setUserData] = useState({
    ...
    email: "ameerabdrabo7@gmail.com",
    phone: "708 737 4997",
    address: {
      line1: "9430 Dundee Pl",
      line2: "Tinley Park, IL",
    },
    gender: "Male",
    dob: "2000-05-07",
      ...
      <div>
        ...
        <div className="grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral">
          ...
          {isEdit ? (
            <select
              onChange={(e) =>
                setUserData((prev) => ({ ...prev, insurance: e.target.value }))
              }
            ...
            <p className="text-gray-400">{userData.insurance}</p>
          )}
        </div>
      </div>
